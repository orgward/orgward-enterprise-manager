...
const INCLUDE = ['server.mjs', 'package.json', 'package-lock.json', 'DELIVERY-STATUS.json', 'src', 'public', 'migrations', 'workers', 'ops/preflight.mjs', 'ops/database-recovery.mjs'];
const EXAMPLES = {
